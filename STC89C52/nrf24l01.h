#ifndef __NRF_H__
#define __NRF_H__
// Pin definitions (CE, CSN, SCK, MOSI, MISO) are declared via sbit in main.c
// before including this header. This header relies on those external declarations.
...
#define NRF_CONFIG ((1<<EN_CRC)|(1<<CRCO))
